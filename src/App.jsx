    ...
    <BrowserRouter>
      <Navbar className="navbar-custom py-3 fixed-top" variant="dark">
        ...
        <div className="ms-auto me-5 pe-5">
          <OverlayTrigger overlay={<Tooltip id="tooltip-DarkMode">DarkMode</Tooltip>} placement="bottom">
            <button className={`switch ${isDarkMode ? 'active' : ''}`} id='switch' onClick={handleClick}>
      ...
      <OverlayTrigger overlay={<Tooltip id="tooltip-github">Ir a GitHub</Tooltip>}>
        <a href="https://github.com/Alancb9/CarShop" target='_blank' class="fixed-icon me-5">
